...
file_path = r'201909模型数据_train_xiong_new.xlsx'
...
df['diff']=diff
df.to_excel(os.path.join(dir,'xiong_output_3side_linear2.xlsx'))

from sklearn.externals import joblib

joblib.dump(value=model, filename=os.path.join(dir,'xiong_3side_linear2.model'))
